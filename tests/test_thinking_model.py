...
def test_advisor_thinking_capabilities():
    ...
    print(f"✅ Found Dr. Ahmad Mahmoud (ID: {advisor_id})")
    ...
    chat_response = requests.post(f"{BASE_URL}/advisor-chat", json=chat_data)
    ...
    step_response = requests.post(f"{BASE_URL}/advisor-chat", json=step_by_step_data)
    ...
    if step_response.status_code == 200:
        ...
        print("✅ Step-by-step response received")
    ...
    if workflow_response.status_code == 200:
        ...
        print("✅ Multi-function workflow completed")
