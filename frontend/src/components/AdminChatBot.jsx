...
export default function AdminChatBot({ user }) {
    ...
    useEffect(() => {
        // Check system health and initialize admin interface
                ...
                if (health.openai_configured) {
                    ...
                    try {
                        const response = await fetch('http://localhost:8000/advisor-chat', {
                            ...
                            body: JSON.stringify({
                                message: "Hello, I'm ready to start my admin session",
                                advisor_id: user.id
                            }),
                        });
                        ...
                        if (response.ok) {
                            ...
                            throw new Error('Failed to initialize admin chat');
                        }
                    } catch (error) {
                        console.error('Failed to get AI greeting:', error);
                        setMessages([{
                            type: 'bot',
                            content: `Hello ${user.full_name}! 👋\n\nI'm your AI system administrator assistant. I can help you manage the entire BRS system.\n\n**Available Actions:**\n• Monitor system health and performance\n• Manage user accounts and permissions\n• Review all course requests across departments\n• Configure system settings\n• Generate system reports and analytics\n• Handle technical issues and debugging\n• Manage database operations\n• Oversee API configurations\n\nWhat can I help you with today?`,
                            timestamp: new Date()
                        }]);
                    }
                } else {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Failed to get admin chat response');
            }
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                ⚙️ System Administrator - {user.full_name}
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <textarea
                        ...
                        placeholder="Ask me about system status, user management, or say something like 'show all pending requests'..."
                        style={{
                            flex: 1,
                            padding: '0.75rem',
                            border: '1px solid #ddd',
